<template>
  <div id='brewery-information'>
    ...
    <a id='add-favorite' href="#" v-on:click.prevent="addToFavorites" v-if="!favoriteIds.includes(brewery.id)" v-show="$store.state.user.authorities[0].name=='ROLE_USER'">Add to Favorites</a>
