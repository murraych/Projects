...
public class App {
    ...
    public static Review[] requestReviewsByHotelId(int hotelId) {
    	...
    	// URL = "http://localhost:3000/hotels/1/reviews"
    }
    
    public static Hotel[] requestHotelsByStarsRating(int stars) {
    ...
    public static City requestWithCustomQuery() {
    	return restTemplate.getForObject
    		("https://api.teleport.org/api/cities/geonameid:5128581/", City.class);
    }
    private static void run() {
        ...
        while(menuSelection != 0) {
            ...
            if (menuSelection == 1) {
                ...
                printHotels(requestHotelsByStarsRating(3));
