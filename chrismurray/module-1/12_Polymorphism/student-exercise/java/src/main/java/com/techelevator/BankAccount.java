...
public class BankAccount implements Accountable{
    ...
    public int transferTo(BankAccount destinationAccount, int transferAmount) {
    	destinationAccount.balance = destinationAccount.balance + transferAmount; // add money to destination account
    	balance = balance - transferAmount; //subtract money from account
