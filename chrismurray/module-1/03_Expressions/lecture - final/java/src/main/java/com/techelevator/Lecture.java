...
public class Lecture {
    ...
    */
    public boolean returnTrueWhenGreaterThanFive(int number) { //argument or parameter called number
        if (number > 5) {
        	return true;
        } else {
    ...
    */
    public boolean returnTrueWhenGreaterThanFiveInOneLine(int number) {
        ...
        // ternary -- return (number > 5)? true: false;
    }
    ...
    */
    public String returnFizzIfThreeUsingTernary(int number) {
        ...
        // return (condition) ? what to do if true: what to do if false;
    }
    ...
    */
    public String returnFizzOrBuzzOrNothing(int number) {
    	...
    	else if (number == 5) {  // else is not needed -- we can just say if because of the return in the above block
    		return "Buzz";
    	}
        return "";
    }
